...
namespace MODEL
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<MODEL.Account> account_primary_contact
		{
			get
			{
				return this.GetRelatedEntities<MODEL.Account>("account_primary_contact", null);
			}
			set
			{
				this.OnPropertyChanging("account_primary_contact");
				this.SetRelatedEntities<MODEL.Account>("account_primary_contact", null, value);
		...
		public System.Collections.Generic.IEnumerable<MODEL.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<MODEL.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<MODEL.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<MODEL.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<MODEL.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<MODEL.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public MODEL.Account contact_customer_accounts
		{
			get
			{
				return this.GetRelatedEntity<MODEL.Account>("contact_customer_accounts", null);
			}
			set
			{
				this.OnPropertyChanging("contact_customer_accounts");
				this.SetRelatedEntity<MODEL.Account>("contact_customer_accounts", null, value);
		...
		public MODEL.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<MODEL.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<MODEL.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public MODEL.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<MODEL.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public MODEL.Account msa_contact_managingpartner
		{
			get
			{
				return this.GetRelatedEntity<MODEL.Account>("msa_contact_managingpartner", null);
			}
			set
			{
				this.OnPropertyChanging("msa_contact_managingpartner");
				this.SetRelatedEntity<MODEL.Account>("msa_contact_managingpartner", null, value);
